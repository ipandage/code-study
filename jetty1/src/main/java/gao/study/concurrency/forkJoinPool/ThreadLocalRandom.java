 ...
 * java.util.Random} but isolated to the current Thread.  Like the global
 ...
 * multiple tasks (for example, each a {@link gao.study.concurrency.forkJoinPool.ForkJoinTask}), use
